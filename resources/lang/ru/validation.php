...
return [
    ...
    */
    ...
    'diff_chars' => 'Поле :attribute должно содержать :count уникальных символов или больше.',
    'refresh_token' => 'Неправильный токен обновления.',
    'token' => 'Неправильный JWT токен.',
    'oauth_provider' => 'Такой платформы не существует.',
