	...
	export default {
		...
		methods: {
			...
			getHeaders() {
				return {
					headers: {
						Authorization: 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsImp0aSI6IjFiZTY2YjJjLTZjMTctNGVhZC04MmY2LWNiNGNjZGQ2MmMwYiJ9..IcdYxVKJeSRIM_XyPX43dI_e9TF8j4yhprGCB3CMvP33qslm1ovJVNWvk7NEfd6ueE454dxqMzYWb6fogLpN2g'
					}
				};	
			}
		}
